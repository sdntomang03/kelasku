...
export default function ExamScreen({ exam, question, questionLoading = false, questionIds, activeQuestion, setActiveQuestion, answers, doubtful, answeredCount, timeLeft, questionError, enableViolation, violationState, onViolation, onDismissViolation, onAnswer, onToggleDoubtful, onFinish, isFinishing, onExit }) {
