        ...
        <div
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <button @click="removeOption(index)"
                    class="w-7 h-7 rounded-full bg-rose-50 text-rose-400 hover:bg-rose-500 hover:text-white transition flex items-center justify-center opacity-0 group-hover:opacity-100"><i
                        class="fas fa-times text-xs"></i></button>
            </div>

            <div class="flex-1">
                <x-editor ::id="'opt_editor_' + index" x-model="opt.option_text" height="80px" :mini="true" />
            </div>
        </div>
    </template>
</div>
